<template>
  ...
  >
    <div>
    <img src="/lat2-smaller.png" alt="Ronald Otieno image" class="float-left pr-2 bg-violet-500 rounded-md w-40 h-40 aspect-[1/2] [clip-path:circle(70%_at_20%_30%)] [shape-outside:circle(70%_at_20%_30%)]">
