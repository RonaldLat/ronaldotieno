<template>
  <form class="flex  gap-2 flex-row items-center w-full max-w-xl mb-4">
    ...
    <button
      type="submit"
      class="items-center justify-center h-12 px-6 text-sm tracking-wide text-white transition duration-200 bg-purple-400 rounded shadow-md w-max md:text-md font-xs md:w-auto hover:bg-purple-700 focus:shadow-outline focus:outline-none"
    >
      subscribe
    </button>
  </form>
